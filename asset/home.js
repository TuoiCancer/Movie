...
const notifyIcon = $(".nav__notify-icon");
const notifyWrap = $(".nav__notify-wrap");
const userWrap = $(".nav__user-wrap");
const userIcon = $(".nav__user-icon");
...
notifyIcon.onclick = (e) => {
  notifyWrap.classList.toggle("active");
};
